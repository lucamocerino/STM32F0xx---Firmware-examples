...
const uint16_t SquareWave[2] = {0, 4095};
uint32_t Idx = 0;
    ...
    if (WaveChange == 1)
    {
      ...
      if (SelectedWavesForm == 0)
      {
          ...
          DMA_InitStructure.DMA_M2M = DMA_M2M_Disable;
					...
					/* Use DMA interrupt in order to go in Standby mode after the end of tranfers */
      ...
      if (SelectedWavesForm == 1) {
		...
		if (SelectedWavesForm == 2){
          ...
          DMA_DeInit(DMA1_Channel3);
					DMA_InitStructure.DMA_PeripheralBaseAddr = DAC_DHR8R1_ADDRESS;
          DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t)&SquareWave;
